...
DEBIAN_FRONTEND=noninteractive apt -qqq install -y libnetfilter-queue1 gnome-screenshot python3-setuptools python3-distutils python3-pip bloodhound vlc ufw xclip terminator crackmapexec sslyze sslscan eyewitness gobuster build-essential; \
...
if [ $WMver == "xfce" ]; then
    ...
    xfconf-query -c xfce4-keyboard-shortcuts  -p /commands/custom/Print -s "kalima screenshot"
