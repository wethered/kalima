...
echo "[+] Installing various hacking tools"
...
echo "[+] Installing Fish & Oh-My-Fish"
...
echo "[+] Adding Obey2 greeting"
echo set fish_greeting >> ~/.config/fish/config.fish;cp scripts/obey2 ~/.config/fish/obey2;echo "~/.config/fish/obey2" >> ~/.config/fish/config.fish;chmod +x ~/.config/fish/obey2

echo "[+] Performing last changes to shell"
