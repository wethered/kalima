...
DEBIAN_FRONTEND=noninteractive apt -qqq install -y bloodhound gnome-screenshot vlc ufw xclip terminator  crackmapexec sslyze sslscan eyewitness gobuster build-essential; \
