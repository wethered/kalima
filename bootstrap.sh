...
DEBIAN_FRONTEND=noninteractive apt -qqq install -y python3-setuptools python3-distutils python3-pip bloodhound gnome-screenshot vlc ufw xclip terminator  crackmapexec sslyze sslscan eyewitness gobuster build-essential; \
